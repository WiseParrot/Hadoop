...
public class LogParser extends EvalFunc<Tuple> {
    ...
    public Tuple exec(Tuple input) throws IOException {
        ...
        try {
            ...
            t.append(line.substring(6, 14));
            t.append(line.substring(38, 45));
            t.append(line.substring(46, 53));
    ...
    public Schema outputSchema(Schema input) {
        try {
            ...
            s.add(new Schema.FieldSchema("maxtemp", DataType.CHARARRAY));
            s.add(new Schema.FieldSchema("mintemp", DataType.CHARARRAY));
